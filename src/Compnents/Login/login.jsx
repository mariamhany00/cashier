  ...
  return (
    <div className="font-inknut flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        <h2 className="mt-10 text-center text-2xl font-bold tracking-tight" style={{ color: '#C20A0A' }}>
          Login
        </h2>
      </div>
        ...
        <form onSubmit={handleSubmit} autoComplete="off" className="space-y-6">
          ...
          <div>
            <div className="flex items-center justify-between">
              <label htmlFor="password" className="block text-sm font" style={{ color: '#246FA8' }}>
                Enter your Password
              </label>
