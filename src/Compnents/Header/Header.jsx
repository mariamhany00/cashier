      ...
      icon: (isActive) => (
        ...
        >
          <path
            ...
            strokeLinejoin="round"
            strokeWidth="2"
            d="M16 8c-1.6-1.6-3.9-1.9-6.1.3-2.1 2.1-7.1 9.7-5.5 11.3s9.2-3.3 11.4-5.5c2.1-2.1 1.8-4.5.1-6.2Zm0 0 3.3-3.2M16 8V4m0 4h4m-3.8 5.8-2.2-2.2M8.3 10.2l2.1 2M9.2 15.4l2.1 2.2"
          />
        </svg>
      ),
    },
  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto p-4 flex justify-between items-center">
        ...
        <button className="flex items-center gap-2 border border-red-600 text-red-600 px-4 py-2 rounded-md hover:text-red-800 hover:border-red-800 transition font-bold">
          Add New Dish
          <svg
            className="w-5 h-5 text-red-600"
            xmlns="http://www.w3.org/2000/svg"
